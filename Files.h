...
string OpenFile();		//Проверка возможности открытия файла. Проверяет, пустой ли файл и существует ли файл. Возвращает имя файла, если он подходит для получения информации.
